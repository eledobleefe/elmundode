...
require_once 'back/bebe_mostrarDatos.php';
...
if(!empty($_SESSION['idUsuario']) && !empty($_SESSION['rol'])) {
	...
	$infoCrecimiento = mostrarInformacionCrecimiento($idBebe);
	$infoDentadura = mostrarInformacionDentadura($idBebe);
	$infoAnecdota = mostrarInformacionAnecdotas($idBebe);
}
...
<section>
	<div class="container-fluid b_verdeClaro my-3">
		<h5 class="text-white text-center text-uppercase py-3 font-weight-light">Nacimiento</h5>
	</div>
	<div class="row">
		<div class="col-sm-6">
			<div class="row">
				<div class="col-12">
					<div class="mostrarFechaNacimiento mx-auto">
						<ul class="display-4 my-5">
							<li class="text-center">
								<?php
								if(isset($infoBebe)) {
									$fecha = new DateTIME($infoBebe['fechaNacimiento']);
									$formatoFecha = $fecha->format('d');
									echo $formatoFecha;
									} else {
			...
			<div class="row">
				<div class="col-12">
					<div class="mostrarHoraNacimiento border mx-auto">
						<ul class="display-4 my-3">
							<li class="text-center">
							<?php 
								if(isset($infoBebe)) {
									$hora = new DateTIME($infoBebe['horaNacimiento']);
									$formatoHora = $hora->format('G');
									echo $formatoHora;
								} else {
									echo "Dato no guardado";
								}
			...
			<div class="row">
				<div class="col-4 mx-auto my-3">
					<p class='mb-0 ml-3'>Lugar de nacimiento:</p>
					<p class='ml-3'><?php 
						if(isset($infoBebe)) {
							echo $infoBebe['lugarNacimiento'];
						} else {
							echo "Dato no guardado";
						}
						?> 
			...
			<div class="row">
				<div class="col-4 mx-auto my-3">
					<p class='mb-0 ml-3'>Ciudad de nacimiento:</p>
					<p class='ml-3'><?php 
						if(isset($infoBebe)) {
							echo $infoBebe['ciudadNacimiento'];
						} else {
							echo "Dato no guardado";
						}
						?> 
		...
		<div class="col-sm-6">
			<div class="row">
				<div class="col-4 mx-auto my-3">
					<p class='mb-0 ml-3'>Tu grupo sanguíneo</p>
					<p class='ml-3'><?php 
						if(isset($infoBebe)) {
							echo $infoBebe['grupoSanguineo'];
						} else {
							echo "Dato no guardado";
						}
						?> 
			...
			<div class="row">
				<div class="col-4 mx-auto my-3">
					<p class='mb-0 ml-3'>La altura inicial:</p>
					<p class='ml-3'><?php 
						if(isset($infoBebe)) {
							echo $infoCrecimiento['altura'] . " cm";
						} else {
							echo "Dato no guardado";
						}
						?> 
			...
			<div class="row">
				<div class="col-4 mx-auto my-3">
					<p class='mb-0 ml-3'>El peso inicial:</p>
					<p class='ml-3'><?php 
						if(isset($infoBebe)) {
							echo $infoCrecimiento['peso'] . " kg";
						} else {
							echo "Dato no guardado";
						}
						?> 
			...
			<div class="row">
				<div class="col-4 mx-auto my-3">
					<p class='mb-0 ml-3'>Tu contorno de cabeza:</p>
					<p class='ml-3'><?php 
						if(isset($infoBebe)) {
							echo $infoCrecimiento['cabeza'] . " cm";
						} else {
							echo "Dato no guardado";
						}
						?> 
...
<section>
	<div class="container-fluid b_verdeClaro my-3">
		<h5 class="text-white text-center text-uppercase py-3 font-weight-light">Cómo creciste</h5>
	</div>
	<div class="row align-items-center justify-content-around my-3">
		<div class="col-12 col-lg-4 p-5 p-lg-0">
			<canvas id="crecimientoAltura" class="d-inline-block"></canvas>
		</div>
		<div class="col-12 col-lg-4 p-5 p-lg-0">
			<canvas id="crecimientoPeso" class="d-inline-block"></canvas>
		</div>
	</div>
	<div class="row align-items-center justify-content-around">
		<div class="col-12 col-lg-4 p-5 p-lg-0">
			<canvas id="crecimientoCabeza" class="d-inline-block"></canvas>
		</div>
	</div>
</section>
<section>
	<div class="container-fluid b_verdeClaro my-3">
		<h5 class="text-white text-center text-uppercase py-3 font-weight-light">Vaya dentadura</h5>
	</div>
	<p class="text-center">
	<?php
		foreach ($infoDentadura as $diente) {
			$fecha = new DateTIME($diente['fechaDiente']);
			$formatoFecha = $fecha->format('d - m - Y');
			echo $formatoFecha . ": " . $diente['ordenDiente'] . "º - " . $diente['nombreDiente'] . "<br/>";
		}
	?>
	</p>
...
<section>
	<div class="container-fluid b_verdeClaro my-3">
		<h5 class="text-white text-center text-uppercase py-3 font-weight-light">Anécdotas inolvidables</h5>
	</div>
	<?php
		echo "<div class='card-columns text-center'>";
		foreach($infoAnecdota as $anecdota) {
			$fecha = new DateTIME($anecdota['fechaAnecdota']);
			$formatoFecha = $fecha->format('d - m - Y');
			echo "<div class='card text-center'>
					<div class='card-body'>
					<h5 class='card-title'>" . $anecdota['nombreAnecdota'] ."</h5>
					<p class='card-text'>" . $anecdota['descripcionAnecdota'] ."</p>
					<p class='card-text'><small class='text-muted'>" . $anecdota['lugarAnecdota'] . " el " . $formatoFecha . "</small></p>
					</div>
				</div>";
		}
		echo "</div>";
	...
	<!-- Gráfico crecimiento-->
	<script>
		var graphAltura= document.getElementById("crecimientoAltura").getContext("2d");
        var miGraph= new Chart(graphAltura,{
            type:"bar",
            data:{
                labels:[
					<?php
						$consulta = $conexion->prepare("SELECT * FROM crecimiento WHERE idBebe = '$idBebe'");
						$consulta->bindParam(':idBebe', $idBebe, PDO::PARAM_INT);
						$consulta->execute();
						$resultado = $consulta->fetchAll();
						foreach ($resultado as $crecimiento) {
							echo "'" . $crecimiento['fechaDatos'] . "',";
						}
					?>
					],
                datasets:[{
		...
		var graphPeso= document.getElementById("crecimientoPeso").getContext("2d");
        var miGraph= new Chart(graphPeso,{
            type:"bar",
            data:{
                labels:[
					<?php
		...
		var graphCabeza= document.getElementById("crecimientoCabeza").getContext("2d");
        var miGraph= new Chart(graphCabeza,{
            type:"bar",
            data:{
                labels:[
					<?php
