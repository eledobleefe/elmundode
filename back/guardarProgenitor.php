...
if($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $buscarProgenitores->bindParam(':nombreProgenitor', $nombreProgenitor, PDO::PARAM_STR);
    $buscarProgenitores->bindParam(':apellidosProgenitor', $apellidosProgenitor, PDO::PARAM_STR);
    $buscarProgenitores->bindParam(':fechaNProgenitor', $fechaNProgenitor, PDO::PARAM_STR);
    $buscarProgenitores->bindParam(':lugarNProgenitor', $lugarNProgenitor, PDO::PARAM_STR);
